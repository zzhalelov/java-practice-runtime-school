...
public class PostHandler implements HttpHandler {
    ...
    static {
        ...
        Post post2 = new Post(2, "Это будет второй пост. Тоже короткий.");
        posts.add(post2);

        Post post3 = new Post(3, "Это пока последний пост.");
        posts.add(post3);
    }
    ...
    private void handlePostComments(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            if (optionalPost.isEmpty()) {
                writeResponse(exchange, String.format("Пост с идентификатором %d не найден", id), 404);
            } else {
